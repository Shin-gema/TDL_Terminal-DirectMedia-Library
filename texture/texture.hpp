...
class Texture {
    public:
        ...
        [[nodiscard]] u_int64_t getWidth() const { return _width; }
        [[nodiscard]] u_int64_t getHeight() const { return _height; }
        ...
        [[nodiscard]] std::optional<u_int64_t> getWidthResized() const { return _widthResized; }
        [[nodiscard]] std::optional<u_int64_t> getHeightResized() const { return _heightResized; }
    ...
    std::string _path;
        ...
        u_int64_t _widthResized = _width;
        u_int64_t _heightResized = _height;
